...
public class Punto {
    ...
    public double getX(){return x;} // declaro un metodo que devuelve la parte x de un punto
    public double getY(){return y;} // declaro un metodo que devuelve la parte y de un punto
    public void setX(double a){x=a;} // declaro un metodo que asigna a a la parte x de un punto
    public void setY(double b){y=b;} // declaro un metodo que asigna b a la parte y de un punto
